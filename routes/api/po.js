...
router.post('/', async (req, res) =>{
    try {
        let { userID, userName, userOffice, customerID, projectID, responsibleID, shipTo, 
            requisitioner, inputDate, poCustomId, products, quantity } = req.body;
        for (let i = 0; i < products.length; i++) {
            ...
            await db.query(`INSERT INTO purchase_orders(
                ...
                ship_to, requisitioner, change_log, delivered, registry, registry_1, registry_2, registry_3, registry_4)
                VALUES (DEFAULT, $1, $2, $3, $4, $5, $6, $7, $8:raw, $9, $10, $11, false, $12, $13, $14, $15, $16);`,
                ...
                poCustomIdParts[2], poCustomIdParts[3]])
            .catch(error =>{
                res.status(500).send(error);
            });
        } 
